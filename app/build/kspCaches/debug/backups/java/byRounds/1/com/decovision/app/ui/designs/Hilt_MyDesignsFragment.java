...
public abstract class Hilt_MyDesignsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyDesignsFragment() {
    super();
  }

  Hilt_MyDesignsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyDesignsFragment_GeneratedInjector) this.generatedComponent()).injectMyDesignsFragment(UnsafeCasts.<MyDesignsFragment>unsafeCast(this));
    }
  }
