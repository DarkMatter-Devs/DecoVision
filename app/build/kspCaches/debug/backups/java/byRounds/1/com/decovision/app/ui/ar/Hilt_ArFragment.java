...
public abstract class Hilt_ArFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ArFragment_GeneratedInjector) this.generatedComponent()).injectArFragment(UnsafeCasts.<ArFragment>unsafeCast(this));
    }
  }
